...
for day in range(25, 30):
    for hour in range(0, 23, 2):
        ...
        return_code = subprocess.call(
             ...
             \'{"metadata": {"time": "2018-09-' + str("%02d" % day) + 'T' + str(
             "%02d" % hour) + ':25:11.875464918Z"}, \
             "app_id": "bigbrewer", "dev_id": "tempsen1", \
             "payload_fields": {"voltage": 4.214, "temperature": ' \
              + str(data) + '}}\' \
             192.168.0.174:5000/temperature/submit', shell=True)
